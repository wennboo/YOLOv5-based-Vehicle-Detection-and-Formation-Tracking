...
echo_and_run cd "/home/xtark/robot_follow_yolo/src/geometry2/tf2_geometry_msgs"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/xtark/robot_follow_yolo/src/geometry2/tf2_geometry_msgs/setup.py" \
     \
    build --build-base "/home/xtark/robot_follow_yolo/build/geometry2/tf2_geometry_msgs" \
    install \
    --root="${DESTDIR-/}" \
