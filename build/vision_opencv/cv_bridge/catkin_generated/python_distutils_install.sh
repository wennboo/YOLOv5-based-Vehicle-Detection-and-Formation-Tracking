...
echo_and_run cd "/home/xtark/robot_follow_yolo/src/vision_opencv/cv_bridge"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/xtark/robot_follow_yolo/src/vision_opencv/cv_bridge/setup.py" \
     \
    build --build-base "/home/xtark/robot_follow_yolo/build/vision_opencv/cv_bridge" \
    install \
    --root="${DESTDIR-/}" \
