...
echo_and_run cd "/home/xtark/robot_follow_yolo/src/vision_opencv/image_geometry"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/xtark/robot_follow_yolo/src/vision_opencv/image_geometry/setup.py" \
     \
    build --build-base "/home/xtark/robot_follow_yolo/build/vision_opencv/image_geometry" \
    install \
    --root="${DESTDIR-/}" \
